 ...
 */
class SAccessories extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('product_id, acc_id', 'required'),
			array('product_id, acc_id', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, product_id, acc_id', 'safe', 'on'=>'search'),
		);
	}
